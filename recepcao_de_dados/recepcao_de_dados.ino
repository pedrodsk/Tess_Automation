...
delay(500);
Serial1.print(F("AT+CIPSEND=54\r\n"));
Serial1.println(F("## C0 2E A8 2E 01 2E 01 00 0D 0A - LEITURA          ##"));
delay(500);
Serial1.print(F("AT+CIPSEND=54\r\n"));
Serial1.println(F("## C0 2E A8 2E 01 2E 01 01 01 0D 0A - LIGAR LED     ##"));
delay(500);
Serial1.print(F("AT+CIPSEND=54\r\n"));
Serial1.println(F("## C0 2E A8 2E 01 2E 01 01 00 0D 0A - DESLIGAR LED  ##"));
delay(500);
Serial1.print(F("AT+CIPSEND=54\r\n"));
Serial1.println(F("##                                                  ##"));
delay(500);
